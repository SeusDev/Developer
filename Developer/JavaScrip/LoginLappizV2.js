...
document.querySelector(
  ...
  document.querySelector("body > app-root > app-auth > app-login > div.row.w-100.mx-0.auth-page > div > div > div > div.col-md-8.pl-md-0 > div > form > div.mt-3 > input:nth-child(4)").style.marginLeft='39%';
  document.querySelector("body > app-root > app-auth > app-login > div.row.w-100.mx-0.auth-page > div > div > div > div.col-md-8.pl-md-0 > div > form > div:nth-child(1) > label").style.marginLeft='38%'
  document.querySelector("body > app-root > app-auth > app-login > div.row.w-100.mx-0.auth-page > div > div > div > div.col-md-8.pl-md-0 > div > form").style.marginTop='12%'