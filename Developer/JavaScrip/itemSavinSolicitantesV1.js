...
if (window.location.href.includes('7d32941b-c3dc-4f90-80d3-0c1176322edf')) {
    ...
    if (sessionStorage.switchPersona) {
        ...
        //grupo
        var query = `insert into PGN_Lappiz_Personas(Id,TipoIdentificacionFK,TipoPersonaFK,Nombre,NumeroIdentificacion,CorreoElectronico,Estado,TiposolicitanteFK,Edited_date,Created_date,EventType,RowStatus) VALUES `
        ...
        data.forEach(element => {
            ...
            query += `('${element.Id}',${MaestroTipoIdentificacion},${TipoPersonaFK},${Nombregrupo},${NumeroIdentificacion},${CorreoElectronico},${Estado},${MaestroTipoInterviniente},GETDATE(),GETDATE(),${EventType},${RowStatus}),`;
    ...
    var dataGrid = sessionStorage.dataSolicitantes ? JSON.parse(sessionStorage.dataSolicitantes) : []
