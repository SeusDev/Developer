...
let StringQuery = `SELECT Id, CEPotencial, TiempoCorrecion, Descripcion FROM pactiatest_lappiz_CriticidadHallazgos`;
        ...
        function cargaDDLCriticidad() {
            ...
            if (data.length > 0) {
                kendo.jQuery("#criticidad").kendoDropDownList({
                    ...
                    dataValueField: "Id",
                    headerTemplate: ` <div class="dropdown-header" style="width:98.5%; padding:0px; display:flex; justify-content: space-between; font-size: medium;">
                    <span class="k-widget k-header"  style="width:33% ; font-size: medium">Potencial</span>
                    <span class="k-widget k-header"  style="width:33% ; font-size: medium">Tiempo corrección</span>
                    <span class="k-widget k-header"  style="width:33% ; font-size: medium">Descripción</span>
                    </div>`,
                     template:
                     '<span class="k-state-default"  style="width:33% !important ; font-size: small;"><p>#: data.CEPotencial #</p></span>'+
                     '<span class="k-state-default"  style="width:33% !important ; font-size: small;"><p>#: data.TiempoCorrecion #</p></span>'+
                     '<span class="k-state-default"  style="width:33% !important ; font-size: small;"><p>#: data.Descripcion #</p></span>',
