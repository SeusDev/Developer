					...
					$("#gridMonitorCotizacion").kendoGrid({
						...
						columns: [
							...
							{ field: "UsuarioAsignado", title: " Usuario asignado" },
							{
								...
								title: "F/Vencimineto cotización",
								...
								command: [
									{
										...
										click: informacion,
										template:
											"<a class='k-grid-informacion btn'><i class='fa fa-info'></i> Información</a>",
									},
								],
							},
							{
								command: [
									{
										...
										click: reasignar,
										template:
											"<a class='k-grid-reasignar btn'><i class='fa fa-refresh'></i> Reasignar</a>",
									},
								],
							},
                        {  
