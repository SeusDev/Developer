    ...
    setTimeout(function () {
        ...
        $("#tipo").change(function (e) {
            ...
            if (parseInt(e.currentTarget.value) == 2 && tipoTransaccion != "") {
                ...
                $('#identifi').data('kendoDropDownList').value("")
                $('#nit').data('kendoDropDownList').value("")
                $('#dcliente').data('kendoDropDownList').value("")
                $('#dproveedor').data('kendoDropDownList').value("")
                $('#ordencompra').data('kendoDropDownList').value("")
                $("#ordencompra").data("kendoDropDownList").enable(false);
            }
        });
        ...
        $("#nit").kendoDropDownList({
            ...
            dataValueField: "NIT",
            template: `<span class="k-state-default"  style="width:50% !important ; font-size: x-small;"><p>#: NIT #</p></span><span class="k-state-default"  style="width:50% !important ; font-size: x-small;"><p>#: NombreCompleto #</p></span>`,
            headerTemplate: `<div class="dropdown-header" style="width:98.5%; padding:0px "><span class="k-widget k-header"  style="width:50% ; font-size: x-small">NIT</span><span class="k-widget k-header"  style="width:50% ; font-size: x-small">NombreCompleto</span>`,
            ...
            debugger
                ...
                $('#nomdetalle').val(getSelected.NIT)
                numord() 
            },
            enable: false
        });
        $("#identifi").kendoDropDownList({
            dataTextField: "NombreCompleto",
            dataValueField: "NumeroIdentificacion",
            template: `<span class="k-state-default"  style="width:50% !important ; font-size: x-small;"><p>#: NumeroIdentificacion #</p></span><span class="k-state-default"  style="width:50% !important ; font-size: x-small;"><p>#:NombreCompleto #</p></span>`,
            headerTemplate: `<div class="dropdown-header" style="width:98.5%; padding:0px "><span class="k-widget k-header"  style="width:50% ; font-size: x-small">Identificación</span><span class="k-widget k-header"  style="width:50% ; font-size: x-small">NombreCompleto</span>`,
            ...
            debugger
                ...
                $('#detallecli').val(getSelected.NumeroIdentificacion)
                numord() 
            },
            enable: false
        })

        $("#dproveedor").kendoDropDownList({
            dataTextField: "Detalle",
            dataValueField: "NIT",
            template: `<span class="k-state-default"  style="width:50% !important ; font-size: x-small;"><p>#: Detalle #</p></span>`,
            headerTemplate: `<div class="dropdown-header" style="width:98.5%; padding:0px "><span class="k-widget k-header"  style="width:50% ; font-size: x-small">DetalleProveedor</span>`,
            valueTemplate: `<span><p style="margin-top:8px">#: Detalle #</p></span>`,
            dataSource: [],
            filter: "startswith",
            optionLabel: "Seleccione un NIT",
            change: function () {
                debugger
                var index = $("#dproveedor").data('kendoDropDownList').select();
                var getSelected = $('#dproveedor').data('kendoDropDownList').dataSource.options.data[index - 1]

                $('#nomprop').val(getSelected.Detalle)
                $('#nomdetallep').val(getSelected.NIT)
                numord()
            },
            enable: false
        });
        $("#dcliente").kendoDropDownList({
            dataTextField: "Detalle",
            dataValueField: "Id",
            template: `<span class="k-state-default"  style="width:50% !important ; font-size: x-small;"><p>#: Detalle #</p></span>`,
            headerTemplate: `<div class="dropdown-header" style="width:98.5%; padding:0px "><span class="k-widget k-header"  style="width:50% ; font-size: x-small">Detalle cliente</span>`,
            valueTemplate: `<span><p style="margin-top:8px">#: Detalle #</p></span>`,
            dataSource: [],
            filter: "startswith",
            optionLabel: "Seleccione un Número de identificación",
            change: function () {
                debugger
                var index = $('#dcliente').data('kendoDropDownList').select();
                var getSelected = $('#dcliente').data('kendoDropDownList').dataSource.options.data[index - 1]

                $('#nomcli').val(getSelected.Detalle)
                $('#detallecli').val(getSelected.Id)
                numord()
            },
            enable: false
        })
        ...
        function LlenarNit() {
            debugger
            let Query = `select distinct p.Id,p.NIT,p.NombreCompleto 
        ...
        function Llenaridenti() {
            debugger
            let Query = `select distinct c.Id,c.NumeroIdentificacion,c.NombreCompleto 
        ...
        function dcliente(id) {
            debugger
            let Query = `select distinct dc.Id,dc.Nombre 'Detalle'
            from Cohan_Lappiz_PedidosClientes pc
            join Cohan_Lappiz_Cliente c on pc.ClienteFk=c.Id
            join Cohan_Lappiz_DetalleCliente dc on pc.DetalleClienteFk=dc.Id
            where pc.Estado='Despachado' and pc.FechaCreacion>= DATEADD(month, -6, GETDATE()) and c.NumeroIdentificacion ='${id}' `

            let data = ajaxQuery(Query)
            $("#dcliente").data("kendoDropDownList").enable(true);
            $("#dcliente").data("kendoDropDownList").setDataSource(data);

        }

        function dproveedor(id) {
            debugger
            let Query = `select distinct dp.Id'IdDetalle', dp.NombreCompleto'Detalle'
            from  Cohan_Lappiz_Recepciones r
            join Cohan_Lappiz_Proveedor p on r.ProveedorFk=p.Id
            join Cohan_Lappiz_DetallesProveedores dp on dp.ProveedorFK=p.Id
            where  r.Estado='Almacenado'  and r.FechaCreacion >= DATEADD(month, -6, GETDATE()) and NIT='${id}'`       

            let data = ajaxQuery(Query)
            $("#dproveedor").data("kendoDropDownList").enable(true);
            $("#dproveedor").data("kendoDropDownList").setDataSource(data)
        }
