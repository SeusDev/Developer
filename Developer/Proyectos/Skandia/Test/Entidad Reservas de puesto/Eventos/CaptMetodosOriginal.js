/* versionamiento Captura de metodos form  */
...
if (idVista == "cb77d1fd-9464-496a-8f32-3c698da7a4c4") {
	setTimeout(function () {
		...
		function sede_change(e) {
			...
			setTimeout(() => {
				debugger;
				var query = `select*from Skandias_Lappiz_Users
		...
		function piso_change(e) {
            ...
            SELECT  *
                    ...
                    where format(BL.FechaBloqueo,'yyyy-MM-dd')='${fecha}'
                    )
		...
		function Save(e) {
			...
			var query1 = `select*from Skandias_Lappiz_Users
            where PuestoFijo='1' and Id='${sessionStorage.userId}'`;
				...
				$.ajax({
					...
					success: function (success) {
						...
						let correo = evalQuery(
							`EXEC Skandias_EnviarReservaPuesto '${success.Id}',${tiene},'${$(
								"#a58bfb96-d84b-484a-a783-10e6786364be"
							).val()}', ${Auditorio}`
						);
						...
						location.assign(
							`#/forms?viewName=Skandias_Lappiz_ReservaDePuesto&entityId=47981612-3721-48ac-99eb-9367114a6127&appViewId=50433a15-2349-4121-b2a2-76fc053d3ab9`
						);
					},
    ...
    if(window.document.location.href.includes('beta')){
