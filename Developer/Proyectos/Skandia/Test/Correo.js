setTimeout(function() {
    ...
    if (window.location.href.includes('appViewId=7d8e05c5-d983-406f-956c-4264c1d6b2a2')) {
        ...
        $("#link").click(function() {
            debugger;
            location.assign(`#/forms?viewName=Skandias_Lappiz_ReservaDePuesto&entityId=47981612-3721-48ac-99eb-9367114a6127&viewMenu&appViewId=cb77d1fd-9464-496a-8f32-3c698da7a4c4`);
        });
        ...
        var email = 'soportepc@vivaldi.net';
        var subject = 'Se ha realizado la reserva en sala de reuniones';
        var text = '';
        var cuerpo = `<h1>
            <p class="card-text" id="Reserva">-Tu reserva es la ${Query[0].NumeroReserva}</p>
            <p class="card-text" id="Oficina">-Oficina ${Query[1].CESede} </p>
            ...
            `;
        ajaxQuerySendEmail(email, subject, text, cuerpo)
    }
