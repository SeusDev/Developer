...
setTimeout(function () {
    ...
    if (window.location.href.includes('appViewId=7a4326f8-2fc0-4555-95ab-ee5d211d5c6e')) {
        ...
        debugger
            ...
            <div>
                ...
                <div style="top: 25%;margin-top:178px; left: 50%;transform: translate(-50%, -50%);color: white !important;font-weight: bold;font-family: Verdana">
                <br>
                <br>
                ${titulo[0].Titulo}
                    
                </div>
                <img class="Imagen" src="https://runtimetest.lappiz.io/assets/img/Anywhere-09.jpg" alt="">
            </div>
            `)
        ...
        function Form(e) {
            ...
            if (this.element[0].id == "ReporteSalud") {
                var url =`#/forms?viewName=Skandias_Lappiz_EncuestasDeSalud&entityId=dc89bad0-5a57-42b1-a446-259ba32fee50&viewMenu&appViewId=6c573d8b-7812-400f-b5a7-f9014e726b04`; //Reporte diario de salud
                goLocation(url);
            } else if (this.element[0].id == "ReservaPuesto") {
                var url =`#/forms?viewName=Skandias_Lappiz_ReservaDePuesto&entityId=47981612-3721-48ac-99eb-9367114a6127&viewMenu&appViewId=cb77d1fd-9464-496a-8f32-3c698da7a4c4`; //Reserva de Puesto
                goLocation(url);
            } else if (this.element[0].id == "ReservaReuniones") {
                var url =`#/forms?viewName=Skandias_Lappiz_ReservaSaladeReuniones&entityId=e9f31bdc-b18a-4931-85ce-bb0ebc5b7e4c&viewMenu&appViewId=ae653b0e-c1c4-4869-a088-e98177c90adc`; //Reserva de Puesto
                goLocation(url);
            } else if (this.element[0].id == "Solicitudes") {
                var url =`#/forms?viewName=Skandias_Lappiz_SolicitudesDeIngresoSinReserva&entityId=38eb5600-1b9d-48f4-b915-5ee729011a83&viewMenu&appViewId=964ee09c-1339-4ee4-94fa-a8fee7199c7a`; //Reserva de Puesto
                goLocation(url);
            } else if (this.element[0].id == "btnReportes") {
                var url =`#/forms?viewName=Skandias_Lappiz_Users&entityId=98d25e73-8dbb-4d69-afe6-4b4c7e9a6db7&viewMenu&appViewId=e34ee7bb-1142-4350-bc6e-13a81280b653`;
                goLocation(url);
        ...
        <div style="text-align: center;">
            <h1 style="position: absolute;top: 25%;left: 50%;transform: translate(-50%, -50%);color: black !important;font-weight: bold;font-family: Verdana; margin-top:145px">
                Reportes</h1>
            <img class="Imagen1" src="https://runtimetest.lappiz.io/assets/img/Generico.jpg" alt="Sin Imagen">
        </div>
        `)
        ...
        function ingresar(e) {
            e.preventDefault();
            var url = '#/forms?viewName=Skandias_Lappiz_EncuestasDeSalud&entityId=dc89bad0-5a57-42b1-a446-259ba32fee50&viewMenu&appViewId=9da0cec2-65a6-4df8-9500-ed536b9a2046';
            goLocation(url);
        }
        ...
        function ingresarReserva(e) {
            e.preventDefault();
            var url ='#/forms?viewName=Skandias_Lappiz_ReporteReservaPuestos&entityId=c250aadc-ac0b-4e5e-bed1-14ca93a2d5ca&viewMenu&appViewId=2f1fff85-c19a-4ea0-b394-3e9cd3c01c3f';
            goLocation(url);
        }
        ...
        function ingresarReservaSala(e) {
            e.preventDefault();
            var url ='#/forms?viewName=Skandias_Lappiz_ReporteReservaSalas&entityId=988e5d69-329d-41a3-a3b6-e6bd0327bef3&viewMenu&appViewId=46942553-4350-40bf-aa64-d9c3cf41b1a6';
            goLocation(url);
        }
    ...
    var nuevoCSS = { "width":'100%',"max-width":'100%',"height":'16rem',"display":'block',"margin": '0 auto'};
    $(".Imagen").css(nuevoCSS);

    var nuevoCSS = { "margin-top": '150px'};
    $(".Imagen1").css(nuevoCSS);
