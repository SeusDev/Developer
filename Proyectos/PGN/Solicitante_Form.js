...
if (window.location.href.includes("7d32941b-c3dc-4f90-80d3-0c1176322edf")) {
  setTimeout(function () {
    ...
    $(`.form-section-title:contains(3.Detalle de información de ubicaciones)`)
      .parent()
      .parent()
      .hide();

    //? ocultar sesion
    $(`.form-section-title:contains(2.Datos de la persona)`)
      .parent()
      .parent()
      .hide();
    ...
    // ? Boton buscar Juridico y grupo
    $("#Buscar").click(function () {
      debugger;

      $("#ContendorGrid").html("");
      $("#ContendorGrid").append(' <div id="Consulta"></div>');

      var Nombregrupo = $("#fee9ac16-2662-4a5d-b689-819e24345dbf").val();
      var Razonsocial = $("#1f48142c-d40f-41aa-8821-6da2113459ea").val();
      var Tipo = $("#9036bc3c-d2ee-4196-8abc-3593999409aa")
        .data("kendoDropDownList")
        .value();
      var TipoInterviniente = $("#ae89d269-3a0a-421b-a4dd-1241c44d2a3d")
        .data("kendoDropDownList")
        .value();
      ...
      if (
        ...
        if (data.length > 0) {
          debugger;
          data[0].TipoInterviniente = sessionStorage.Tipointerviente;
          if (sessionStorage.Tipodocumento)
            if (!sessionStorage.Tipodocumento.includes('cedescripcin')) {
              setFieldValue(
                "ba221603-80f6-43eb-b611-97097646abe2",
                data[0].Tipodocumento
              );
            } else {
              data[0].Tipodocumento = sessionStorage.TipoDocumento;
            }
          else
            setFieldValue(
              "ba221603-80f6-43eb-b611-97097646abe2",
              data[0].Idtipodocumento
            );
            data[0].AregloTipoducumento = '{"Id":"26781617-775F-491C-A34E-A7C9443B9E6A","CEDescripcin":"Nit"}'
          setTimeout(() => {
            $("#Consulta").kendoGrid({
              dataSource: {
                data: data,
                ...
                schema: {
                  model: {
                    fields: {
                      ...
                      AregloTipoducumento: { type: "string", editable: false },
        ...
        toastr.warning(
          "Agrege el item a buscar y seleccione tipo de interviniente",
          "Atención"
        );
      }
    });
    ...
    $("#Consultar").click(function () {
      ...
      var Tipodocumento = $("#ba221603-80f6-43eb-b611-97097646abe2")
        .data("kendoDropDownList")
        .value();
      var NumeroIdentificacion = $(
        "#ddbc36a7-f9b7-4d91-872d-1db43e79cea2"
      ).val();
      var TipoInterviniente = $("#ae89d269-3a0a-421b-a4dd-1241c44d2a3d")
        .data("kendoDropDownList")
        .value();
      if (
        ...
        if (Tipodocumento != "") {
          ...
          var query = `select isnull (p.Nombre,'') [Nombre],
            ...
            full join pgn_lappiz_maestrotipopersona mp on p.TipoPersonaFK = mp. Id
            full join pgn_lappiz_maestrotipoidentificacion ti on P.TipoIdentificacionFK = ti.Id
            where P.NumeroIdentificacion ='${NumeroIdentificacion}' and ti.Id='${Tipodocumento}'and P.RowStatus='Active'`;
          ...
          if (data.length > 0) {
            ...
            let grid = $("#Consulta").data("kendoGrid");
        ...
        toastr.warning(
          "Primero diligencie una cedula para la busqueda",
          "Atención"
        );
      }
    });
    ...
    $("#AgregarNatural").click(function () {
      debugger;
      if (
        $("#ae89d269-3a0a-421b-a4dd-1241c44d2a3d")
          .data("kendoDropDownList")
          .value() != ""
      ) {
        ...
        let tipoDocumento = $("#ba221603-80f6-43eb-b611-97097646abe2")
          .data("kendoDropDownList")
          .text();
        var TipoInterviniente = $("#ae89d269-3a0a-421b-a4dd-1241c44d2a3d")
          .data("kendoDropDownList")
        ...
        if (TipoInterviniente != "") {
          ...
          setFieldValue("ae89d269-3a0a-421b-a4dd-1241c44d2a3d", "");
        } else toastr.warning("Primero seleccione el tipo de interviente");
      } else toastr.info("Seleccionar tipo de interviente");
    });
    ...
    $("#Nuevogrupo").click(function () {
      ...
      if (
        $("#fee9ac16-2662-4a5d-b689-819e24345dbf")
          .data("KendoDropDrownList")
          .value() != nombre
      ) {
    ...
    $("#AgregarGrupo").click(function () {
      ...
      let Direcciones = JSON.stringify(
        $("#bb0bed1f-dded-4706-a219-0bf3a8718ed8")
          .data("kendoGrid")
          .dataSource.data()
      );
      var TipoInterviniente = $("#ae89d269-3a0a-421b-a4dd-1241c44d2a3d")
    ...
    function onChange(e) {
      ...
      rows.each(function (e) {
        var grid = $("#Consulta").data("kendoGrid");
