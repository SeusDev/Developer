...
setTimeout(function () {
    ...
    if (window.location.href.includes('appViewId=7a4326f8-2fc0-4555-95ab-ee5d211d5c6e')) {
        ...
        function ingresar(e) {
            ...
            location.assign(`${url}/#/forms?viewName=Skandias_Lappiz_EncuestasDeSalud&entityId=dc89bad0-5a57-42b1-a446-259ba32fee50&viewMenu&appViewId=9da0cec2-65a6-4df8-9500-ed536b9a2046`)
        }
        ...
        function ingresarReserva(e) {
            e.preventDefault();
            var url = window.origin 
            location.assign(`${url}/#/forms?viewName=Skandias_Lappiz_ReporteReservaPuestos&entityId=c250aadc-ac0b-4e5e-bed1-14ca93a2d5ca&viewMenu&appViewId=2f1fff85-c19a-4ea0-b394-3e9cd3c01c3f`)
        }
        ...
        function ingresarReservaSala(e) {
            e.preventDefault();
            var url = window.origin 
            location.assign(`${url}/#/forms?viewName=Skandias_Lappiz_ReporteReservaSalas&entityId=988e5d69-329d-41a3-a3b6-e6bd0327bef3&viewMenu&appViewId=46942553-4350-40bf-aa64-d9c3cf41b1a6`)
        }
