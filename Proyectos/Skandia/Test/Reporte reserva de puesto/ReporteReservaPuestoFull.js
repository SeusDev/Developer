...
setTimeout(function () {
    ...
    users.Email,
	CASE 
	WHEN reserva.AsientoFK IS NULL 
	THEN IIF(reserva.PuestoFijo = 'Si' AND reserva.Auditorio = 'No', 'Puesto fijo', 'Auditorio')
	ELSE asiento.CENombreAsiento
	END as Asiento,
    ...
    jornada.Jornada, reserva.PuestoFijo, reserva.Auditorio
    ...
    WHERE ${querySede} (format(reserva.FechaAsistirOficina,'yyyy-MM-dd') BETWEEN '${fechaInicio}' AND '${fechaFin}')`
