...
if (idVista == 'cb77d1fd-9464-496a-8f32-3c698da7a4c4') {
    ...
    Reserva de puesto</h1>   -->            
        ...
        $("#TomarAlmuerzoOficinaSi").click(function(e) { MostrarSeccion() })
        $("#TomarAlmuerzoOficinaNo").click(function(e) { OcultarSeccion() })
        ...
        $("#9f5510ec-79cb-4130-9c77-bafa54fece06").data("kendoDropDownList").value("645277EB-6EE1-4045-9D57-458276DCA320")


        let dataAlmuerzo = evalQuery('select Id,HoraAlmuerzo from Skandias_Lappiz_HoraAlmuerzo order  by Orden')
        $("#bf487094-c89e-4b57-aa1c-25e6c8f17bc1").data('kendoDropDownList').setDataSource(dataAlmuerzo)
        ...
        function sede_change(e) {
            ...
            if (e.sender.dataItem().Video != null) {
                let video = `<iframe width="560" height="315" src="https://www.youtube.com/embed/${e.sender.dataItem().Video.split("v=")[0]}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="display: block; margin: auto;"></iframe>`
                $('#video').append(video)
            }
            if (e.sender.dataItem().CESede == 'Bogotá') {
                ...
                let data = evalQuery(`select COUNT(Id) [Cantidad] from Skandias_Lappiz_ReservaDePuesto  where FORMAT(FechaAsistirOficina,'yyyy-MM-dd') = '${fecha}' and TomarParqueadero = 'Si'`)
                ...
                $("#parqueadero").css("display", "none") //oculta toma de almuerzo                  
                $('#HoraAlmuerzo').css("display", "none")
            }
                        ...
                        <div class="card-subcontent" style="display: block !important; ">
                            ...
                            <div class="card-description">
                                <div class="description" style="    margin-top: 10px;">
                                    <iframe src="https://${videos[i].split(":")[1]}?autoplay=0&muted=0" allow="autoplay;"
            ...
            let piso = evalQuery(`select * from Skandias_Lappiz_Pisos where SedeFK ='${e.sender.dataItem().Id}'`)
            ...
            if (piso.length > 1) {
                ...
                let Ubicacion = evalQuery(`select * from Skandias_Lappiz_Ubicacion where PisoFK ='${piso[0].Id}'`)
        ...
        $("#a58bfb96-d84b-484a-a783-10e6786364be").data("kendoDropDownList").bind("change", sede_change);
        ...
        function fecha_change(e) {
            ...
            var jornada = $('#9f5510ec-79cb-4130-9c77-bafa54fece06').val()
            var ubicacion = $("#39ed6b48-9366-4010-94da-5524fa06c0d3").data("kendoDropDownList").dataItem().Id
            ...
            var sede = $('#a58bfb96-d84b-484a-a783-10e6786364be').data("kendoDropDownList").dataItem().CESede
            if (sede === "Bogotá") {
                if (new Date().format('Y-m-d') == fecha) {
                    if (new Date().getHours() >= 11) {
                        $("#almuerzo").css("display", "none")
        ...
        $("#ee21ffdc-d4a6-434b-a4b5-eac631c5f59e").dxDateBox("instance").on("valueChanged", fecha_change)
        ...
        function piso_change(e) {
            debugger
            e.preventDefault()
            let Ubicacion = evalQuery(`select * from Skandias_Lappiz_Ubicacion where PisoFK ='${e.sender.dataItem().Id}'`)
            $("#39ed6b48-9366-4010-94da-5524fa06c0d3").data('kendoDropDownList').setDataSource(Ubicacion)
            if (Ubicacion.length > 1) {
                $("#Ubicaciones").css("display", "block")
            } else {
        ...
        $("#31a1f5de-030f-46ac-88b5-18a43a4b9f51").data("kendoDropDownList").bind("change", piso_change);
        ...
        $("#39ed6b48-9366-4010-94da-5524fa06c0d3").data("kendoDropDownList").bind("change", ubicacion_Change)

        function ConsultarAsientos(UbicacionId, fecha, jornada) {

            if ($("#a58bfb96-d84b-484a-a783-10e6786364be").data("kendoDropDownList").dataItem().CESede === "Bogotá") {
                let data = evalQuery(`select COUNT(Id) [Cantidad] from Skandias_Lappiz_ReservaDePuesto  where FORMAT(FechaAsistirOficina,'yyyy-MM-dd') = '${fecha}' and TomarParqueadero = 'Si'`)
                if (data[0].Cantidad >= 20) {
                    $("#parqueadero").css("display", "none")
                } else {
        ...
        function Save(e) {
            ...
            if (window.location.href.includes('cb77d1fd-9464-496a-8f32-3c698da7a4c4')) {
                if ($("#a58bfb96-d84b-484a-a783-10e6786364be").val() == '' || $("#a58bfb96-d84b-484a-a783-10e6786364be").val() == null) {
                ...
                if ($("#ee21ffdc-d4a6-434b-a4b5-eac631c5f59e > div.dx-dropdowneditor-input-wrapper > div > input").val() == '') {
            ...
            if ($("#bf487094-c89e-4b57-aa1c-25e6c8f17bc1").data("kendoDropDownList").value() !== "") {
                HoraAlmuerzoFk = $('#bf487094-c89e-4b57-aa1c-25e6c8f17bc1').data("kendoDropDownList").dataItem().Id
                HoraAlmuerzo = $('#bf487094-c89e-4b57-aa1c-25e6c8f17bc1').data("kendoDropDownList").dataItem().HoraAlmuerzo
            } else {
                HoraAlmuerzoFk = null
                HoraAlmuerzo = null
            }
            ...
            if ($('#9f5510ec-79cb-4130-9c77-bafa54fece06').data("kendoDropDownList").value() !== "") {
                Jornadafk = $('#9f5510ec-79cb-4130-9c77-bafa54fece06').data("kendoDropDownList").dataItem().Id
                Jornada = $('#9f5510ec-79cb-4130-9c77-bafa54fece06').data("kendoDropDownList").dataItem().Jornada
            } else {
                Jornadafk = null
                Jornada = null
            }
            ...
            var observacion
            if ($('#2c5f4791-95b0-4e91-8b95-988444a2dc82').val() !== "") {
                observacion = $('#2c5f4791-95b0-4e91-8b95-988444a2dc82').val()
            } else {
                observacion = null
            }
            ...
            $.ajax({
                ...
                success: function(success) {
                    ...
                    let correo = evalQuery(`EXEC Skandias_EnviarReservaPuesto '${success.Id}'`)
                    ...
                    location.assign(`#/forms?viewName=Skandias_Lappiz_ReservaDePuesto&entityId=47981612-3721-48ac-99eb-9367114a6127&appViewId=50433a15-2349-4121-b2a2-76fc053d3ab9`);
        ...
        function ConsultarAlmuerzo(fecha) {
            let cantidad = evalQuery(`	select COUNT(Id) [Cantidad] from Skandias_Lappiz_ReservaDePuesto where TomarAlmuerzoOficina = 'Si' and  FORMAT(FechaAsistirOficina, 'yyyy-MM-dd') ='${fecha}'`)
