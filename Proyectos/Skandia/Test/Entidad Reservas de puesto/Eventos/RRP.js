...
if (idVista == '50433a15-2349-4121-b2a2-76fc053d3ab9') {
    setTimeout(function() {
        ...
        if (JSON.parse(sessionStorage.LappizUser).PuestoFijo == true) {
            ...
            let Query = {
                "query": `Select RP.NumerodeReserva, (select CEsede from Skandias_Lappiz_Sedes
                    where Id= '${sessionStorage.IdSede}')as CESede,FORMAT(RP.FechaAsistirOficina,'dd-MM-yyyy') FechaAsistirOficina, JA.Jornada, 'Puesto fijo' AS CENombre, 'Puesto fijo' AS CENombreUbicacion, 'Puesto fijo' as CENombreAsiento, RP.TomarAlmuerzoOficina, RP.TomarParqueadero, isnull(Enquehorario,'N/A') Horario
