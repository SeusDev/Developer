...
if (idVista == '5ca202b6-3426-46bc-b240-15fe650c01db') {
    ...
    setTimeout(function () {
        ...
        function Monicoti() {
            ...
            var stringQuery = ` select distinct bi.Id,bi.Consecutivo,bi.CodigoCliente,bi.NombreCliente,bi.Origen,bi.NumeroItems,u.Usuarios'UsuarioAsignado',bi.FechaVencimiento
                ...
                if (data.length == 0) {
                    ...
                    $("#gridMonitorCotizacion").kendoGrid({
                        ...
                        columns: [
                            ...
                            { command: [{ text: "asignar", click: asignar, template: "<a class='k-grid-asignar btn'><i class='fas fa-user-check'></i> Asignar</a>" }] },
                        ],
                    });
                }
            });
        ...
        function cotizamonito() {
            ...
            $.each(allSelected, function (index, e) {
                ...
                selectMonitor.push({
                    ...
                    'Consecutivo': allSelectedItems[index].Consecutivo,
        ...
        function informacion(e) {
            ...
            if (dataItem.length == 0) {
                ...
                var stringQuery = `select bi.Id,bi.Consecutivo,p.CodigoProducto,p.NombreProducto
                                from Cohan_Lappiz_DetalleBionexo dbi
        ...
        $('#guardarAsing').click(function () {
            debugger
            if (confirm('¿Desea guardar el usuario asignado?')) {
                ...
                execQuery(stringQuery).then(success => {
                    ...
                    $("#modalasignar").modal('hide');
                    Monicoti()
                    toastr.success('Usuario signado con éxito')
        ...
        $('#Asignar').click(function () {
            debugger
            var grid = $("#gridMonitorCotizacion").data("kendoGrid");
            var usucoti = grid.dataSource.options.data[0].Id;
            if (confirm('¿Desea asignar el usuario?')) {
                var asignado =  $("#usuario").val();
                var stringQuery = `update Cohan_Lappiz_Bionexo
                            set UsuarioAsignadoFK='${asignado}'
                            where Id='${usucoti}' `
                ...
                execQuery(stringQuery).then(success => {
                    ...
                    $("#modalasignar").modal('hide');
                    Monicoti()
                    toastr.success('Usuario asignado con éxito')
