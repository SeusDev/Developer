...
if (idVista == "f3a5c9ab-1242-45c8-80b0-3813e7034f99") {
	setTimeout(() => {
		...
		$("#btnGenerarReporte").click(function () {
			...
			if (fechaFinal && fechaInicial) {
						...
						columns: [
							{
								...
								title: "Fecha Ingreso",
								template:
									"#= kendo.toString(kendo.parseDate(FechaCreacion, 'yyyy-MM-dd'), 'yyyy/MM/dd') #",
							},
							{
								field: "Proveedor",
								title: "Proveedor",
							...
							},
							{
								...
								template:
									"#= kendo.toString(kendo.parseDate(FechaVencimientoInvima, 'yyyy-MM-dd'), 'yyyy/MM/dd') #",
							},
							{
								field: "Lote",
								title: "Lote",
							...
							},
							{
								...
								template:
									"#= kendo.toString(kendo.parseDate(FechaCreacion1, 'yyyy-MM-dd'), 'yyyy/MM/dd') #",
							},
						],
						//selectable: true
					});
                ...
                setTimeout(() => {  
                    ...
                    var grid = $("#grid-producto-recepcion")
                    grid.find(".k-grid-toolbar").on("click", ".btnPDF", function (e) {
                    e.preventDefault();
                    toolbar_click();
		...
		function toolbar_click() {
			...
			var win = window.open(`https://bi.lappiz.io/ReportServer/Pages/ReportViewer.aspx?%2fReport+Parts%2fCohan_Lappiz%2fCohan_Lappiz_Acta_Recepcion_SF&rs:Command=Render&fechaInicial=${fechaInicial}&fechaFinal=${fechaFinal}&rs:embed=false`,'_blank')
            win.focus()
